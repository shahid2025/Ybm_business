...
class _HomeScreenState extends State<HomeScreen> {
  ...
  void initState() {
    ...
    super.initState();
    naviData
        .add(_drawerData('assets/drawer_icon_images/person.png', 'Profile'));
    naviData.add(_drawerData(
        'assets/drawer_icon_images/person.png', 'My Business Listing'));
    naviData.add(_drawerData(
        'assets/drawer_icon_images/notification.png', 'Notification'));
    ...
    naviData.add(_drawerData(
        'assets/drawer_icon_images/bookmark.png', 'Bookmarked Businesses'));
    naviData.add(
        _drawerData('assets/drawer_icon_images/search.png', 'Business Search'));
    ...
    naviData
        .add(_drawerData('assets/drawer_icon_images/settings.png', 'Settings'));
    naviData.add(_drawerData(
        'assets/drawer_icon_images/contact_us_icons.jpg', 'Contacts Us'));
  }
                    ...
                    itemBuilder: (context, int index) {
                      return GestureDetector(
                        onTap: () {
                          if (naviData[index].text == 'Profile') {
                          ...
                          } else if (naviData[index].text ==
                              'My Business Listing') {
                          } else if (naviData[index].text == 'Notification') {
                            Navigator.pushNamed(
                                context, RoutesName.tabbar_notification);
                            ...
                            Navigator.pushNamed(
                                context, RoutesName.BookedMarkedScreen);
                          } else if (naviData[index].text ==
                              'Business Search') {
                            Navigator.pushNamed(
                                context, RoutesName.searchTabbarScreen);
                          }
                          ...
                          //    }
                            ...
                            Navigator.pushNamed(
                                context, RoutesName.Faqs_Screen);
              ...
              GestureDetector(
                ...
                child: Container(
                  ...
                  child: Text(
                    'Terms & Cnditions',
                    style: TextStyle(
                        fontSize: 12, color: Color(0xff000000).withOpacity(.5)),
                  ),
                ),
              ),
              GestureDetector(
              ...
              GestureDetector(
                ...
                child: Container(
                  ...
                  child: Text(
                    'Logout',
                    style: TextStyle(
                        fontSize: 12, color: Color(0xff055473).withOpacity(.5)),
                  ),
                ),
              ),
            ],
                ...
                child: Row(
                  ...
                  children: [
                    ...
                    Container(
                      ...
                      child: Image.asset("assets/images/YBM_LOGO.png"),
                    ),
                    GestureDetector(
                      onTap: () {
                        Navigator.pushNamed(
